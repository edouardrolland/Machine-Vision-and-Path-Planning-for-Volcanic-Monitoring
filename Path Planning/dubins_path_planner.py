...
import numpy as np
from utils_dubins import angle_mod, rot_mat_2d, plot_arrow
...
def main():
    ...
    if show_animation:
        ...
        plot_arrow(start_x, start_y, start_yaw, arrow_length=1.0, head_width=0.1)
        plot_arrow(end_x, end_y, end_yaw, arrow_length=1.0, head_width=0.1)
        plt.legend()
        plt.grid(True)
        plt.axis("equal")
        plt.show()
